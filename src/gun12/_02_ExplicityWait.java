...
public class _02_ExplicityWait extends BaseStaticDriver {
    ...
    public static void main(String[] args) throws InterruptedException {
       ...
       // Element bulundugu anda sure devam etmeyecek olup isleme devam etmeyi saglar.
       ...
       // WebElement webDriver = driver.findElement(By.xpath("//p[text()='WebDriver']"));
        ...
        System.out.println("Web Driver = "+webDriver.getText());

        Thread.sleep(1000); //sayfanin son halini gormek icin yazilabilir.
        driver.quit();
    }
}
